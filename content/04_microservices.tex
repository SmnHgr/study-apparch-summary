...
\includegraphics[width=\linewidth]{microservices-ui-1.png} \\

Microservice gibt spezifischen Anteil zu UI Rahmen

\includegraphics[width=\linewidth]{microservices-ui-2.png} \\

Microservies haben kein UI sondern nur Service-Schnittstelle, realisiert durch UI Full Client

\includegraphics[width=\linewidth]{microservices-ui-3.png}
...
\includegraphics[width=\linewidth]{microservices-persistence-1.png} \\

Zentraler DB-Service

\includegraphics[width=\linewidth]{microservices-persistence-2.png} \\
